...
public class MatrixSearch
{
    ...
    private Point findRegion(final int value, final int[][] matrix, final int rowLow, final int colLow,
	    final int rowHigh, final int colHigh)
    {
	...
	if (rowLow == rowHigh && colLow == colHigh)
	    return new Point(colLow, rowLow);
